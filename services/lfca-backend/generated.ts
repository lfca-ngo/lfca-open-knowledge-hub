...
export type CompletedCompanyActionsQueryVariables = Exact<{
  [key: string]: never
}>

export type CompletedCompanyActionsQuery = {
  __typename?: 'Query'
  completedCompanyActions: Array<{
    __typename?: 'CompanyAction'
    commentAttachmentCount: number
    commentCount: number
    companiesCompletedCount: number
...
export type PlannedCompanyActionsQueryVariables = Exact<{
  [key: string]: never
}>

export type PlannedCompanyActionsQuery = {
  __typename?: 'Query'
  plannedCompanyActions: Array<{
    __typename?: 'CompanyAction'
    commentAttachmentCount: number
    commentCount: number
    companiesCompletedCount: number
...
export function useCompletedCompanyActionsQuery(
  options?: Omit<
    Urql.UseQueryArgs<CompletedCompanyActionsQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<CompletedCompanyActionsQuery>({
...
export function usePlannedCompanyActionsQuery(
  options?: Omit<
    Urql.UseQueryArgs<PlannedCompanyActionsQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<PlannedCompanyActionsQuery>({
